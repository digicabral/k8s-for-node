...
- Docker hub image: [digicabral/nodejs-postgres-api-example](https://hub.docker.com/r/digicabral/nodejs-postgres-api-example/)
...
docker run -p 3000:3000 \
    ...
    digicabral/nodejs-postgres-api-example:latest
```
